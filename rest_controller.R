...
#* @post /backtest
function(Stg = "bb", StgID = "ppp", UID = "ss", Share = "IRO1APPE0001", Timeframe = "hourly",StartDate = "2014-01-01",EndDate = "2100-01-01",Vol = 1000,MaxPos = 10,ReEnterType = 0,ReEnterAmount = 0) {
  res <- Backtest(Stg,UID,Share,Timeframe = Timeframe,StartDate = StartDate,EndDate = EndDate,Vol = Vol,MaxPos = MaxPos,Fee = TRUE,Over = TRUE,ReEnterType = ReEnterType,ReEnterAmm = ReEnterAmount)
